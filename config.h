...
static const char *dmenucmd[] = { "dmenu_run", "-p", "Run:", "-m", dmenumon,  "-l", "10", NULL };
...
static Key keys[] = {
	...
	{ 0,       XF86XK_MonBrightnessUp,         spawn,          CMD("brightnessctl", "-q", "set", "5%+") },
	{ 0,       XF86XK_MonBrightnessDown,       spawn,          CMD("brightnessctl", "-q", "set", "5%-") },
	{ ShiftMask, XF86XK_MonBrightnessUp,       spawn,          CMD("brightnessctl", "-q", "set", "1%+") },
	{ ShiftMask, XF86XK_MonBrightnessDown,     spawn,          CMD("brightnessctl", "-q", "set", "1%-") },
	/* wm patches */
